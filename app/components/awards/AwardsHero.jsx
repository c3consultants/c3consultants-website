...
import { HiSparkles, HiTrendingUp, HiStar } from 'react-icons/hi';
      ...
      <div className="container-custom relative z-10">
        ...
        >
          ...
          <p className="text-xl md:text-2xl text-white/90 mb-8 max-w-3xl mx-auto leading-relaxed">
            Celebrating 23+ years of visionary leadership, community service excellence, 
            and unwavering commitment to empowering lives
          </p>

          {/* Stats */}
          <div className="grid grid-cols-3 gap-6 md:gap-12 pt-8">
            {[
              { icon: HiStar, number: '15+', label: 'Awards' },
              { icon: HiTrendingUp, number: '23+', label: 'Years Service' },
              { icon: HiSparkles, number: '6', label: 'Leadership Roles' },
            ].map((stat, index) => {
